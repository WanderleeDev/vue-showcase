<template>
  <div
    class="product-card rounded-md shadow-xl overflow-hidden z-[100] relative cursor-pointer snap-start shrink-0 py-4 px-3 bg-white flex flex-col items-center justify-center gap-3 transition-all duration-300 group"
    style="width: 25vw; min-width: 250px; max-width: 350px"
  >
    <div class="para uppercase text-center leading-none z-40">
      <p
        style="
          -webkit-text-stroke: 1px rgb(207, 205, 205);
          -webkit-text-fill-color: transparent;
        "
        class="z-10 font-bold text-xl -mb-5 tracking-wider text-gray-500"
      >
        Ninendo Switch2 clone
      </p>
    ...
    <div
      ...
      style="width: 15vw; min-width: 120px; max-width: 180px; aspect-ratio: 1/1"
    >
      <svg
      ...
      >
        <p
          class="text-[#7b956a] font-semibold uppercase group-hover:delay-1000 transition-all opacity-0 group-hover:opacity-100 group-hover:transition-all group-hover:duration-500"
          style="font-size: 1.3vw; min-font-size: 14px; max-font-size: 20px"
        >
          Toner
        </p>
        <ul class="flex flex-col items-start gap-2">
          ...
          >
            ...
            <p
              class="font-semibold text-[#495c48]"
              style="font-size: 0.9vw; min-font-size: 10px; max-font-size: 14px"
            >
              Hydration
            </p>
          </li>
